...
const protocolCopy = require("./protocolCopy.ro");
const rhythmBlueprint = require("./rhythmBlueprint.ro");
const energyAtmosphere = require("./energyAtmosphere.ro");
...
const presenceCopy = require("./presenceCopy.ro");
const moodCopy = require("./moodCopy.ro");
const conversationCopy = require("./conversationCopy.ro");
const rhythmCompact = require("./rhythmCompact.ro");
const dailyProtocol = require("./dailyProtocol.ro");
